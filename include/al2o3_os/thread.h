...
AL2O3_EXTERN_C bool Os_ConditionalVariableCreate(Os_ConditionalVariable_t *cd);
AL2O3_EXTERN_C void Os_ConditionalVariableDestroy(Os_ConditionalVariable_t *cd);
AL2O3_EXTERN_C void Os_ConditionalVariableWait(Os_ConditionalVariable_t *cd, Os_Mutex_t *mutex, uint64_t waitms);
AL2O3_EXTERN_C void Os_ConditionalVariableSet(Os_ConditionalVariable_t *cd);
